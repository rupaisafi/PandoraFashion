var Controller = new function () {
    this.Wait = true;
    var that = this, name = 'Employee', view = $('<div class="add_view">'), formModel = {}, IsNew = true, oldTitle = document.title, windowModel, callerOptions, formInputs;
    ...
    var dropDownList = new function () {
        ...
        this.Bind = function (elm, value) {
            bindDropDownList({
                Id: 'Role', url: '/Employees/Designations',
            });
        };
    };
