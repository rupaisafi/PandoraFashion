var Order = new function () {
    ...
    this.Grid = new function () {
        ...
        function getBackgroundColor(model) {
            ...
            {
                model.ProductionStartAT = parseInt(model.ProductionStartAT.substring(6));
                model.CurrentDate = parseInt(model.CurrentDate.substring(6));
                model.DeliveryDate = parseInt(model.DeliveryDate.substring(6));
