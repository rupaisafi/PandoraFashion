var Controller = new function () {
    ...
    function loadBuyer(id) {
        Global.CallServer('/Buyers/Details/' + id, function (response) {
    ...
    this.Show = function (options) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Areas/Buyer/Templates/Details.html', function (response) {
                Global.Free();
